...
class Aggregator {
  public:
    ...
    DataTablePtr aggregate(DataTable*, PyObject*, PyObject*);
...
DECLARE_FUNCTION(
  aggregate,
  "aggregate(self, col_min=[], col_max=[], min_rows=500, n_bins=500, nx_bins=50, ny_bins=50, nd_max_bins=500, max_dimensions=50, seed=0, progress_fn=None, nthreads=0)\n\n",
