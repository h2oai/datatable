...
int ISNA_I1(int8_t x) { return x == NA_I1; }
int ISNA_I2(int16_t x) { return x == NA_I2; }
int ISNA_I4(int32_t x) { return x == NA_I4; }
int ISNA_I8(int64_t x) { return x == NA_I8; }
int ISNA_U1(uint8_t x) { return x == NA_U1; }
int ISNA_U2(uint16_t x) { return x == NA_U2; }
int ISNA_U4(uint32_t x) { return x == NA_U4; }
