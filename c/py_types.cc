...
template <typename T>
static PyObject* stype_vchar_T_tostring(Column* col, size_t row) {
...
static PyObject* stype_object_pyptr_tostring(Column* col, size_t row)
{
...
static PyObject* stype_notimpl(Column* col, size_t)
{
