...
#ifndef FLATBUFFERS_GENERATED_JAY_FBJAY_H_
#define FLATBUFFERS_GENERATED_JAY_FBJAY_H_
...
inline bool VerifyStats(flatbuffers::Verifier&, const void*, Stats type) {
  return Stats_NONE <= type && type <= Stats_Float64;
}
...
inline const fbjay::Frame *GetFrame(const void *buf) {
  return flatbuffers::GetRoot<fbjay::Frame>(buf);
}

inline const fbjay::Frame *GetSizePrefixedFrame(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<fbjay::Frame>(buf);
}

inline bool VerifyFrameBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fbjay::Frame>(nullptr);
}

inline bool VerifySizePrefixedFrameBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fbjay::Frame>(nullptr);
}

inline void FinishFrameBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<fbjay::Frame> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_JAY_FBJAY_H_
