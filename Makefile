...
$(BUILDDIR)/rowindex.o : c/rowindex.cc $(BUILDDIR)/column.h $(BUILDDIR)/datatable.h $(BUILDDIR)/datatable_check.h $(BUILDDIR)/rowindex.h $(BUILDDIR)/types.h $(BUILDDIR)/utils.h $(BUILDDIR)/utils/assert.h $(BUILDDIR)/utils/omp.h
	@echo • Compiling $<
	@$(CC) -c $< $(CCFLAGS) -o $@
