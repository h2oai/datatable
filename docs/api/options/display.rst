...
.. toctree::
     ...
     allow_unicode       <display/allow_unicode>
     head_nrows          <display/head_nrows>
     interactive         <display/interactive>
     max_column_width    <display/max_column_width>
     max_nrows           <display/max_nrows>
     tail_nrows          <display/tail_nrows>
