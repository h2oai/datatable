...
.. changelog::
    ...
    -[enh] Added reducer function :func:`dt.prod()`  [#3140]

    -[new] Class :class:`dt.FExpr` now has method :meth:`.prod()`,
      which behaves exactly as the equivalent base level function :func:`dt.prod()`.
