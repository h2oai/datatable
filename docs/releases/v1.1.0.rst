...
.. changelog::
    ...
    -[new] Added function :func:`dt.ffill()`, as well as :meth:`.ffill()` method,
      to fill null values with previous non-null value. [#3279]

    -[new] Added function :func:`dt.bfill()`, as well as :meth:`.bfill()` method,
      to fill null values with next non-null value. [#3279]
