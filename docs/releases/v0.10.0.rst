...
.. changelog::
  ...
  -[new] Added function :func:`update`, which can be used to in a ``DT[i, j]``
  ...
  -[enh] Method :meth:`Frame.copy() <datatable.Frame.copy>` now has a new
  ...
  -[enh] Method :meth:`.to_csv() <datatable.Frame.to_csv>` gains two new boolean
