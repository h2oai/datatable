...
.. changelog::
  ...
  -[gh]     :user:`Anmol Bal <abal5>`

  People who contributed with bug reports and feature requests:

  -[gh]     :user:`Arno Candel <arnocandel>`
  -[gh.new] :user:`Antorsae <antorsae>`
  -[gh.new] :user:`Hawk Berry <hawkberry>`
  -[gh]     :user:`Jonathan McKinney <pseudotensor>`
  -[gh]     :user:`Mateusz Dymczyk <mdymczyk>`
  -[gh.new] :user:`NachiGithub <NachiGithub>`
  -[gh]     :user:`Olivier <goldentom42>`
  -[gh]     :user:`Pasha Stetsenko <st-pasha>`
  -[gh]     :user:`Tom Kraljevic <tomkraljevic>`
  -[gh.new] :user:`Yu Zhu <XiaomoWu>`
