...
.. changelog::
  ...
  -[api] The behaviour of a frame method :meth:`.sort() <.sort>` is made consistent with
    the function :func:`sort() <datatable.sort>`. When the list of columns to sort
  ...
  -[fix] :func:`rbind()`-ing an iterator of frames created on-the-fly no longer
    produces an undefined behavior. [#2621]
